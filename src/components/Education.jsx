          ...
          {educationHistory.map((edu, index) => (
            ...
            >
              ...
              <motion.div
                ...
                className="relative md:absolute md:left-1/2 md:top-4 md:-translate-x-1/2 
                           w-16 h-16 bg-gray-100 border-cyan-800 rounded-full 
                           flex items-center justify-center z-10 border-4 
                           overflow-hidden mb-4 md:mb-0"
              >
                <img
                  src={edu.imageUrl}
                  alt={`${edu.school} logo`}
              ...
              >
                <motion.div
                  ...
                  className="w-full max-w-lg md:w-[40%] p-10 
                             border-b border-cyan-400 rounded-lg 
                ...
                >
                  ...
                  <p className="text-md font-semibold text-gray-300 mb-3">
                    {edu.field}
                  </p>
